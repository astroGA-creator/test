          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
            ...
            <div>
              <div className="mb-8">
                ...
                <h2 className="fluid-title-h2 font-bold text-white serif-font">
                  什麼是占星？
                </h2>
              </div>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <article className="rounded-[2rem] p-7 sm:p-8 border border-[#d28b4c]/35 bg-gradient-to-br from-[#162f3a]/90 to-[#07141a] shadow-xl">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-white serif-font mb-3">
              系列二・太陽／水星／木星
            </h3>
